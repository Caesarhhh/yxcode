...
import cv2
# 数据集类别名
names = ['QR', 'DataMatrix', 'PDF417', 'Aztec', 'MicroQR']  # class names
# yolov5s网络中的三个detect层
target_layers = ['model_0_bn','model_1_conv_1','model_2_branch2_7','model_3_2_branch2_7',\
    'model_12_act','model_15_bn2', 'model_16_bn2','model_17','model_18_bn2','model_19_bn2', 'model_21_bn2']
 
# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="/mnt/cephfs/home/chenzhuokun/git/yxcode/yanxiangCode/runs/train/v5le-1280-downv3-5x5/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='/mnt/cephfs/dataset/Detection/yxcode_origin_small/test_crop/images', help='input image path')
parser.add_argument('--output-dir', type=str, default='outputs_gradcam/', help='output dir')
parser.add_argument('--img-size', type=int, default=1280, help="input image size")
parser.add_argument('--target-layer', type=str, default='model_22_m_0',
