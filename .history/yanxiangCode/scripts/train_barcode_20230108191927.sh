...
python -m torch.distributed.launch \
--master_port 14562 --nproc_per_node 2 train.py --cfg "models/yolov5l-e-doubledown-patch-3573-eseb-msv5.yaml" --weights 'pretrain/yolov5l-e-doubledown-patch-3573-eseb-et-msv4.pt' \
--data data/yx_barcode.yaml --img 640 --epoch 1000 \
--hyp cfg/hyp.scratch_best.yaml --batch-size 32 --device $CUDA_VISIBLE_DEVICES --name v5le-76msv2-640-barcode-nofix --exist-ok --cache 'ram'